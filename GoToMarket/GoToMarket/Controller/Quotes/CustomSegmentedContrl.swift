...
class CustomSegmentedContrl: UIControl {
    ...
    private func setupViews() {
        ...
        selector = UIView.init(frame: CGRect.init(x: 0, y: 0, width: 0.0, height: 3.0))
    ...
    private func setupFrames() {
        ...
        let selectorY = self.bounds.maxY - 3.0
        selector.frame = CGRect(x: 0.0, y: selectorY, width: selectorWidth, height: 3.0)
