...
class DetailViewController: UIViewController {
    ...
    private func loadWikiData() {
        ...
        wikiManager.getWikiText(fromItemName: itemData.cropName, success: { [weak self] (text) in
            ...
            if itemData.cropName.trimed() == "玉米" {
                ...
                outputText = GoToMarketConstant.wikiForCorn
            }
            //
    ...
    private func setChangingProps() {
        ...
        incartNoticeView.configureTheme(
            backgroundColor: UIColor.gray,
            foregroundColor: UIColor.white,
            iconImage: incartImage,
            iconText: nil)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .intro:
            ...
            guard let cell = detailTableView.dequeueReusableCell(
                ...
                for: indexPath) as? DetailIntroTableViewCell else { return UITableViewCell() }
        ...
        case .quotes:
            ...
            guard let cell = detailTableView.dequeueReusableCell(
                ...
                for: indexPath) as? DetailQuotesTableViewCell else { return UITableViewCell() }
        ...
        case .history:
            ...
            guard let cell = detailTableView.dequeueReusableCell(
                ...
                for: indexPath) as? DetailHistoryTableViewCell else { return UITableViewCell() }
...
extension DetailViewController: DetailTableViewCellDelegate {
    ...
    func priceInfoButtonTapped(sender: UIButton) {
        ...
        guard let calculateVC = UIStoryboard.calculate().instantiateInitialViewController() as? CalculateViewController else { return }
